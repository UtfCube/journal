...
api.add_resource(modules.Tutors, '/api/tutors')
...
api.add_resource(modules.GeneratePassword, '/api/users/<username>/password')
api.add_resource(modules.Users, '/api/users')